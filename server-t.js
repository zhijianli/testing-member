...
app.post("/depression-web/EapEmployee/entireImportEmployee.json", (req, res) => {
    const proxyRequest = http.request({
        host: process.env.NODE_URL || '192.168.0.103',
...
app.post("/depression-web/EapEmployee/partialImportEmployee.json", (req, res) => {
    const proxyRequest = http.request({
        ...
        host: process.env.NODE_URL || "192.168.0.103", //232 => 25
...
//     const proxyRequest = http.request({
//         host: process.env.NODE_URL || '192.168.0.103',
//         port: process.env.NODE_PORT || 80808080,
//         path: req.path,
//         method: req.method,
//         headers: {
//             "Content-Type": req.headers["content-type"],
...
app.post("/depression-netsales/*", (req, res) => {
