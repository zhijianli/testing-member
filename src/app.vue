 ...
 -->
    <div class="wrap">
        <section id="section" v-if="loginState">
            ...
            <ul class="menu">
               <li>
                <a href="https://review.menganhealth.cn:9001/scaleManagement" class="active">
               ...
               <li>
                <a href="https://review.menganhealth.cn:9001/scaleTypeManagement" class="active">
                    <i class="icon icon-heart"></i>
                    <span>量表类型管理</span>
                    <i class="icon icon-chevron-right"></i>
                </a>
               ...
               <li>
                <a href="https://review.menganhealth.cn:9001/scaleFlowManagement" class="active">
                    <i class="icon icon-heart"></i>
                    <span>量表流水管理</span>
                    <i class="icon icon-chevron-right"></i>
                </a>
