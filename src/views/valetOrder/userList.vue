...
//                    time: '',
        ...
        methods: {
            ...
            async sureToVletFn(){
                ...
                // pid	咨询师ID	number
                params.pid = this.userInformation.psychoId
                ...
                // customerProfession	问题描述	string

                this.consultContent && (params.customerProfession = this.consultContent)
                this.customerSex && (params.customerSex = this.customerSex)
                this.customerAge && (params.customerAge = parseInt(this.customerAge))
                params.userId = this.userId

                // mobilePhone	用户手机号	string

                params.mobilePhone = this.userInformation.consumerMobilePhone

                params.platformChannel = this.userInformation.platformStr


                console.log(params)


                let data = await getResponses('netsalesUser/addNewBespeakService.json', this.serialize(params))
                if (data.code === 0) {
