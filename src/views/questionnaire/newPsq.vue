<template>
                ...
                <tbody>
                    <tr v-for='item in sectionList'>
                        ...
                        <td>
                            ...
                            <span class="pointer" @click='clearing($index,item.sectionId,2)'>修改</span>
    ...
    <div id="myAlert" class="modal {{drop.dropState}}" style="width:600px;">
      ...
      <div v-show='drop.whichWindow == 0'>
          ...
          <!-- <div class="modal-body" v-show='drop.whichWindow == 0'>  -->
              ...
              <div class="topic-content">
                 <div class="my-control-group" v-for='item in questionsChangeList.optList'>
                     <span class="span2 m-wrap baseline"><i class="close-but pointer" @click='deleteSelect($index)'>×</i>选项：</span>
                     <input type="text"   class="displaySub baseline"  v-model="item.title">

                     <span class="span2 m-wrap baseline">选项分数：</span>
                     <input type="text" class="displaySub baseline" placeholder="请输入选项分数"  v-model="item.score">
                 </div>
              </div>
...
import {
		getTestingType,  //下拉列表
		testingSave,     //保存并新增
		testingQuestionsChangeStatus,    // 题目 启用 禁用
		testingQuestionsUpdate,          // 题目 修改
		testingQuestionsSave,            // 题目 新增

		testingSectioncChangeStatus,     // 答案 启用 禁用
		testingSectionUpdate,            // 答案 修改
		testingSectionSave,              // 答案 新增

		listByTestingIdTheQuestions,     // 题目 列表
		listByTestingIdTheSection,       // 答案 列表
