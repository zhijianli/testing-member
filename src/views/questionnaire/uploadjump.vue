            ...
            <table class="table table-bordered table-striped" id="DataTables_Table_0">
                ...
                <tbody>
                    <tr v-for='item in sectionList'>
                        ...
                        <td>{{item.title}}</td>
                        <td>{{item.detail}}</td>
                        <!--<td><img :src="'http://oml9ntix5.qnssl.com/'+ item.filePath" alt=""></td>-->
    ...
    <div id="myAlert" class="modal {{drop.dropState}}" style="width:1100px; left: 36%;">
      ...
      <div v-show='drop.whichWindow == 0'>
          ...
          <div class="modal-body" >
              ...
              <div class="my-control-group" v-for='item in questionsChangeList.optList'> <!-- 修改已有 11111111111111111111111111111 -->
    ...
    methods:{
        async getTestingView(){  //原问卷
            ...
            if( data.code == 0 ){
                ...
                this.filePathPc = data.obj.filePath
                this.filePathMobile =data.obj.filePathMobile
                this.filePathSlide =data.obj.filePathSlide
...
// resId 结论id  number  必填
        ...
        newAddSelect(){  //xxxxxxxxx  optType
          ...
          let  newoptShow = this.newTodo.optShow
          let  newType = this.newTodo.optType
          // let  newTag = this.newTodo.jumpResultTag
          // let  newNo = this.newTodo.jumpToQuestionNo
          if(newType == 0){
            if (newTitle&&newoptShow&&newType){
        ...
        clearing( num,id,whichWindow ){  //修改弹窗  0问题  2答案
          ...
          if(whichWindow == 0){
              ...
              this.questionsChangeList.optShow = this.questionsList[num].title
          }
          if(whichWindow == 2){
              this.sectionId = id
              this.sectionNum = num
            ...
            //   this.filePath.newPicRel = this.sectionList[num].thumbnail
              ...
              console.log(`newPicRel:${this.preView.newPicRel}`)
              //..............
