<template>
    ...
    <div class="container-fluid mid">
        ...
        <div class="tab-cont">
            <ul class="tagTit" style="margin:0 auto;">
                <li :class="{ show: !TabState}" @click="switchCharacterFn(false, 0)">用户端</li>
                <li :class="{ show: TabState}" @click="switchCharacterFn(true, 4)">专家端</li>
            </ul>
        </div>

        <div style="padding:20px;" class="widget-box">
            <div class="tab-cont">
                <ul class="tagTit" v-if="!TabState">
                    <li :class="{'show': switchTab == 0 }" @click="switchFn(0)">首页</li>
                    <li :class="{'show': switchTab == 1 }" @click="switchFn(1)">找专家</li>
                    <li :class="{'show': switchTab == 5 }" @click="switchFn(5)">测试首页</li>
                    <!--<li :class="{'show': switchTab == 2 }" @click="switchFn(2)">问专家</li>-->
                    <!-- <li :class="{'show': switchTab == 3 }" @click="switchFn(2)">心友圈</li> -->
                </ul>

                <ul class="tagTit" v-if="TabState">
                    <li :class="{'show': switchTab == 4 }" @click="switchFn(4)">广场</li>
                </ul>
            </div>
                ...
                <tbody>
                   <tr v-for="item of list">
                       ...
                       <td>
                           ...
                           <a v-if="!TabState" href="javascript:;" @click="changeRoute(`/app_banner/${item.bannerId}`)">编辑</a>
                           <a v-if="TabState" href="javascript:;" @click="changeRoute(`/app_banner/banner2/${item.bannerId}`)">编辑</a>
            ...
            <div class='bottom' style="display:fix">
                ...
                <p>
                    ...
                    <a v-if="!TabState" class="btn btn-warning" id="addVip" href="javascript:;" @click="changeRoute('/app_banner/new_app_banner')">新增</a>
                    <a v-if="TabState" class="btn btn-warning" id="addVip" href="javascript:;" @click="changeRoute('/app_banner/new_app_banner2')">新增</a>
